...
public class TesteSuporte {
	...
	public static void main(String[] args) {
		...
		if (op == 1) {
				...
				System.out.print("Digite o ID do cliente que deseja atrelar à mensagem:");
			...
			System.out.print("Digite a mensagem:");
			suporte.setMensagem(msg = s.nextLine());
			System.out.print("Digite o ID do Cliente  atrelado à mensagem: ");
			suporte.setIdCliente(id1 = Integer.parseInt(s.nextLine()));
			...
			System.out.print("Digite o ID da mensagem que você deseja remover: ");
